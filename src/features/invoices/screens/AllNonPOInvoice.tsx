...
// export default function AllNonPOInvoice({ navigation }) {
...
//   useEffect(() => {
//     fetchAllNonPOInvoices();
//   }, []);

//   const fetchAllNonPOInvoices = async () => {
//     try {
//       const res = await api.post('/nonPOInvoice/getAll');
...
//     return (
//       <View style={styles.center}>
//         <Text style={styles.empty}>No Non-PO Invoices found</Text>
//       </View>
//     );
//   }
...
//         String(item?.NonPOInvoiceId || item?.Invoice_Id || item?.id || index)
//       }
...
//         {/* <Text style={styles.title}>Non PO Invoices</Text> */}
//         <TouchableOpacity
...
export default function AllNonPOInvoice({ navigation }) {
  ...
  useEffect(() => {
    fetchAllNonPOInvoices(filters, 1);
    fetchEntities();
  }, []);
  ...
  const loadMore = () => {
    ...
    fetchAllNonPOInvoices(filters, nextPage, true);
  };
